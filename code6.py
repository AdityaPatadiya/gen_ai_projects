...
text = open("marwadi_university.txt", "r").read()
...
with open("marwadi_university_embeddings.json", "w") as json_file:
    json.dump(embeddings, json_file)
print("Embeddings saved to marwadi_university_embeddings.json")
